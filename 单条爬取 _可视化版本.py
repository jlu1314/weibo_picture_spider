...
def download():
    # link = f"python 单条爬取.py {key_word.get()}"
    link = "python 单条爬取 - 副本.py"
    print(f"正在下载，请稍后……")
    print_url()
...
def main():
    ...
    #     # url_host = 'https://wx3.sinaimg.cn/large/'
...
if __name__ == '__main__':
    ...
    root.title("微博图片下载")
    root.geometry("400x50+650+400")


    txt = tk.Label(text="请输入微博链接：", font=60)
    ...
    bt = tk.Button(text="下载", command=main)
